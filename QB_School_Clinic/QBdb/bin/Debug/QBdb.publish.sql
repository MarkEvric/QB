...
GO
PRINT N'Creating Table [dbo].[QBTable]...';
...
CREATE TABLE [dbo].[QBTable] (
    ...
    PRIMARY KEY CLUSTERED ([QBId] ASC)
);


GO
PRINT N'Creating Procedure [dbo].[QBcreate]...';
...
RETURN 0
GO
PRINT N'Creating Procedure [dbo].[QBdelete]...';
...
RETURN 0
GO
PRINT N'Creating Procedure [dbo].[QBdisplay]...';
...
RETURN 0
GO
PRINT N'Creating Procedure [dbo].[QBsearch]...';
...
RETURN 0
GO
PRINT N'Creating Procedure [dbo].[QBupdate]...';
...
END
GO
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'e8a36d60-359f-4bb0-854a-61082793a43d')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('e8a36d60-359f-4bb0-854a-61082793a43d')
